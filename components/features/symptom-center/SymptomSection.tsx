...
import { brandAppliances, BrandData } from "@/utils/data/brandAppliances";
                  ...
                  <DropdownMenuContent className="w-(--radix-dropdown-menu-trigger-width) max-h-[300px] overflow-y-auto px-4">
                    {availableAppliances.map((appliance) => (
                      <DropdownMenuItem
                        ...
                        className={`capitalize ${selectedAppliance === appliance
                  ...
                  >
                    ...
                    >
                      <CardHeader className="pb-3">
                        <CardTitle
                          className={`text-base font-semibold leading-tight transition-colors ${selectedIssues.has(index)
                              ? "text-[#003d82]"
