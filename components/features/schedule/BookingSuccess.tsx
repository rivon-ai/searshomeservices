...
import type { AppointmentRecord } from "@/types/repairTypes";
    ...
    useEffect(() => {
        ...
        const fetchAppointment = async () => {
            try {
                ...
                console.error("[BookingSuccess] Failed to fetch appointment:", error);
            } finally {
                setLoading(false);
            }
        };
    ...
    if (!appointment) {
        return (
            <div className="text-center py-20 text-red-500">
                Could not find appointment details.
            </div>
        );
    }

    const fullAddress = appointment.address
        ? [
              appointment.address.streetAddress,
              appointment.address.suite,
        ...
        <div className="w-full mx-auto animate-in fade-in slide-in-from-bottom-6 duration-700 ease-out">
            ...
            <div className="bg-[#EFF9E8] rounded-xl p-8 pt-12 relative text-center border border-gray-100 shadow-sm mt-8">
                ...
                <h2 className="text-2xl font-bold text-[#00245B] mb-4">
                    {appointment.customer.firstName}, you&apos;re all set!
                </h2>

                <p className="text-[#00245B] text-lg mb-8">
                    You have successfully scheduled your Service appointment for{" "}
                    <span className="font-bold">
                        {appointment.serviceDate} from {appointment.serviceTime}.
                    </span>
                </p>
            ...
            <div className="py-8 space-y-6 text-gray-600">
                <p>
                    One of our highly trained technicians will arrive at{" "}
                    <span className="text-gray-800 font-medium">{fullAddress}</span>{" "}
                    during the time and date listed above.
                </p>

                <p>
                    We have sent a confirmation email to{" "}
                    <span className="text-[#0046BE] font-medium">
                ...
                <div className="space-y-3">
                    <p className="font-medium text-gray-700">
                        If you opted in, you will also receive a text message:
                    </p>
                    <ul className="list-disc pl-5 space-y-1">
                        <li>
                            On your day of service with a narrowed time window for your
                            appointment
                        </li>
                ...
                <div className="pt-2">
                    <p className="font-bold text-[#00245B]">
