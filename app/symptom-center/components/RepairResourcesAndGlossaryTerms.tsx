...
const repairResources: RepairResource[] = [
    {
        ...
        readTime: "7 min read",
        date: "Dec. 17",
        description: "When it's time to call in professional appliance technicians for repair, trust Sears Home Services.",
    ...
    },
    {
        ...
        readTime: "6 min read",
        date: "Dec. 17",
        description: "Learn how a mixing valve works to control water temperature in a washer.",
        category: "Washer",
    ...
    },
    {
        ...
        readTime: "4 min read",
        date: "Dec. 17",
        description: "Discover how to find thoroughly vetted home services contractors and get reliable professionals for your projects.",
        category: "HVAC",
        categoryLink: "/blog/repair/hvac-resources",
        imageUrl: Image3,
        imageAlt: "homeowner using a vetted Sears Home Services appliance technician",
    ...
    },
    {
        ...
        readTime: "6 min read",
        date: "Dec. 17",
        description: "Get expert troubleshooting tips for your Samsung fridge with our comprehensive guide.",
    ...
    return (
        <div className="mb-6 md:mb-10">
            ...
            <div className="max-w-xl mx-auto">
                <h2 className="text-[#003d82] text-4xl mb-4 px-4 lg:px-0 lg:mb-8">Repair Resources</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 md:gap-6">
                    {repairResources.map((resource, index) => (
...
const recentSymptoms: Symptom[] = [
    {
        ...
        description: "When your Payne central air conditioner won't turn on or isn't cooling, check for power problems, a failed capacitor, or a clogged condensate drain. This guide covers quick, safe troubleshooting steps and explains when to call Sears Home Services for expert central AC repair.",
        link: "/symptom/payne-central-air-not-working"
    },
    {
        title: "ICP central air not working",
        description: "When your ICP central air conditioner won't turn on or isn't cooling, check for power problems, a failed capacitor, or a clogged condensate drain. This guide covers quick, safe troubleshooting steps and explains when to call Sears Home Services for expert central AC repair.",
        link: "/symptom/icp-central-air-not-working"
    },
    {
        title: "Heil central air not working",
        description: "When your Heil central air conditioner won't turn on or isn't cooling, check for power problems, a failed capacitor, or a clogged condensate drain. This guide covers quick, safe troubleshooting steps and explains when to call Sears Home Services for expert central AC repair.",
        link: "/symptom/heil-central-air-not-working"
    },
    {
        title: "Carrier central air not working",
        description: "When your Carrier central air conditioner won't turn on or isn't cooling, check for power problems, a failed capacitor, or a clogged condensate drain. This guide covers quick, safe troubleshooting steps and explains when to call Sears Home Services for expert central AC repair.",
    ...
    return (
        <div className="max-w-300 lg:mx-auto">
            <div className="mx-4 lg:max-w-149 lg:mx-auto lg:mt-6 mb-12">
                <h3 className="text-[#003d82] mb-0 text-4xl">Recent Appliance Symptoms</h3>
                <div className="mt-8">
...
const glossaryTerms: GlossaryTerm[] = [
    {
        ...
        description: "The drum is the core part of the washer that holds your laundry and enables the cleaning process through rotation, agitation, and rinsing.",
        link: "/glossary/what-is-a-washer-drum"
    },
    {
        title: "What is a 608 Certification?",
        description: "The 608 Certification, mandated by the Environmental Protection Agency (EPA), is required for HVAC technicians to legally handle refrigerants. It ensures technicians understand refrigerant types, environmental impact, and proper handling techniques.",
        link: "/glossary/what-is-a-608-certification"
    },
    {
        title: "What is a Compressor?",
        description: "A compressor is a mechanical device that increases the pressure of a gas by reducing its volume, essential in various systems including refrigerators, air conditioners, and HVAC units for cooling and refrigeration processes.",
        link: "/glossary/what-is-a-compressor"
    },
    {
        title: "What is a Condenser?",
        description: "A condenser is a component of HVAC and refrigeration systems, responsible for releasing absorbed heat from the refrigerant into the outside air or a water line, thus facilitating the cooling process.",
