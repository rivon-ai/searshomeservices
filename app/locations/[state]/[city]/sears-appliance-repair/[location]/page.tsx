...
import { Calendar, Droplet, FileCheck, Flame, Refrigerator, Snowflake, Star, User, WashingMachine, Wind, Wrench } from 'lucide-react'
    ...
    return (
        <div className='w-full xl:w-[75%] mx-auto mt-6'>
            ...
            <div className='flex justify-between gap-4 pt-48'>
                ...
                {<div className='w-full max-w-sm '>
                    <Card className="p-6 bg-gray-300 border rounded-lg flex flex-col gap-3">
                        ...
                        <div className='text-blac flex items-center gap-2 font-semibold'> Or Call <Link href="tel:512-337-4522" className="text-black"> 512-337-4522 </Link></div>
                    </Card>
                </div>}
            </div>
           ...
           <RatingSites />
            ...
            <TermsAndApplianceSymptom glossaryTerms={glossaryTerms} symptoms={symptoms} />
        </div>
    )
}