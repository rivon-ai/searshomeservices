...
export function extractMeta(nodes: SymptomNode[]) {
...
export function extractStats(nodes: SymptomNode[]): StatsItem[] {
...
export function extractRepairs(nodes: SymptomNode[]): RepairItem[] {
...
export function extractFaqs(nodes: SymptomNode[]): FaqItem[] {
    const faqs: FaqItem[] = [];
...
export function extractTestimonials(nodes: SymptomNode[]): TestimonialItem[] {
...
export function extractGlossary(nodes: SymptomNode[]): GlossaryItem[] {
...
export function extractCrossLinks(nodes: SymptomNode[], currentSlug: string): CrossLinkItem[] {
...
export function extractOtherBrandsLinks(nodes: SymptomNode[], currentSlug: string): CrossLinkItem[] {
    const links: CrossLinkItem[] = [];
...
export function extractBlogPosts(nodes: SymptomNode[]): BlogPostItem[] {
...
export function extractQuickRepairSteps(nodes: SymptomNode[]): QuickRepairData | undefined {
